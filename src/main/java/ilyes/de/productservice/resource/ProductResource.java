package ilyes.de.productservice.resource;
...
import ilyes.de.productservice.config.log.logtype.LogTypeProductConstants;
import ilyes.de.productservice.mapper.to.ProductCreateOrUpdateTo;
import ilyes.de.productservice.mapper.to.ProductTo;
import ilyes.de.productservice.service.ProductService;
...
public class ProductResource {
    ...
    @GetMapping("")
    @WithResourceLogs(logType = LogTypeProductConstants.PRODUCT_GET_ALL_HANDLE_REQUEST)
    public List<ProductTo> getAllProducts() {
        return productService.getAllProducts();
    }

    @GetMapping("/{id}")
    @WithResourceLogs(logType = LogTypeProductConstants.PRODUCT_GET_BY_ID_HANDLE_REQUEST)
    ...
    @WithResourceLogs(logType = LogTypeProductConstants.PRODUCT_CREATE_HANDLE_REQUEST)
    ...
    @PutMapping("/{id}")
    @WithResourceLogs(logType = LogTypeProductConstants.PRODUCT_UPDATE_HANDLE_REQUEST)
    ...
    @DeleteMapping("/{id}")
    @WithResourceLogs(logType = LogTypeProductConstants.PRODUCT_DELETE_HANDLE_REQUEST)
